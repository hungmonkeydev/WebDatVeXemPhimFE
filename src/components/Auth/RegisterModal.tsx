        ...
        <div className="p-8 flex flex-col items-center my-2 max-h-[85vh] overflow-y-auto custom-scrollbar">
          ...
          <form onSubmit={handleRegister} className="w-full flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label
                className="text-[13px] text-gray-500 font-medium">Họ và tên<span className="text-red-500 ml-0.5">*</span>
              </label>
              <input
                type="text"
                value={fullName}
            ...
            <div className="flex flex-col gap-1.5">
              <label
                className="text-[13px] text-gray-500 font-medium">Email<span className="text-red-500 ml-0.5">*</span>
              </label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex flex-col gap-1.5">
              <label
                className="text-[13px] text-gray-500 font-medium">Số điện thoại<span className="text-red-500 ml-0.5">*</span>
              </label>
              <input
                type="tel"
                value={phone}
            ...
            <div className="flex flex-col gap-1.5">
              <label
                className="text-[13px] text-gray-500 font-medium">Mật khẩu<span className="text-red-500 ml-0.5">*</span>
              </label>
            ...
            <div className="flex flex-col gap-1.5">
              <label
                className="text-[13px] text-gray-500 font-medium">Nhập lại mật khẩu<span className="text-red-500 ml-0.5">*</span>
              </label>
              <div className="relative">
                <input
